...
let About = (props) => {
  ...
  let [userName, setUserName] = useState('Yao Si!')
  ...
  let onGoToHomeClick = (evt) => {
    ...
    evt.preventDefault() //it stops the default behavior like event propagation
  }
  return (
    <div className="about">
      <h2>We promise to support .... </h2>
      <p className="about-content">
        If you’re looking for a job—a great job—we can help you get in the door at some incredible companies. Need to
        hire good people? We know thousands. Let us introduce you. No matter where you are, we can help you get where
