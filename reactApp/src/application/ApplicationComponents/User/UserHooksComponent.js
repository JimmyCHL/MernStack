...
const UserHooksComponent = (props) => {
  ...
  const [uName, setUserName] = useState(user.userName) //user.userName - defined in userReducer
  const [pass, setPassword] = useState(user.password)
