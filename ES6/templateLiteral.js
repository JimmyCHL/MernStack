...
// `` - use back tick or tild operator and write your string, html, variables etc it will return the data in same structure
...
const jimmyInfo = { name: 'Jimmy', age: 30, state: 'SC', country: 'USA' }

const getAge = (obj) => obj.age

let myInfo = `My name is ${jimmyInfo.name} and I am ${getAge(jimmyInfo)} years old. Also I am living in ${
  jimmyInfo.state
}, ${jimmyInfo.country}`
