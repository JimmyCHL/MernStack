...
// If we explicitly concatenate values we must stringify before use
console.log('Different animal sounds are ' + JSON.stringify(animalSoundES6))

// consol.log - method is implementing JSON.stringify() when we use object with , (comma)
console.log('Different animal sounds are ', animalSoundES6)

console.log('This is string ' + {}.toString()) // [object Object] is the default string representation of an object.
