...
function PrintInfo(heading) {
  //console.log(this) //this - is referred as dynamic context and is changeable as per the context setting
  console.log(`
                ${heading}
                ${this.name}
                ${this.age}
...
PrintSessionInfo.apply(null, sessionListOct) //it sets the context to null and should probably out the global context whatever its current global context is.
